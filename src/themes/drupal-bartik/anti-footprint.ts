...
const config: ThemeAntiFootprint = {
    ...
    // Drupal core's stock robots.txt — verbatim from a fresh
    // install. The `Crawl-delay: 10`, the `/core/` + `/profiles/`
    // listings, the dual clean-URL / index.php blocks and the
    // boilerplate comment header are all Drupal-specific tells
    // that no other CMS replicates.
